...
class TableFields {
    ...
    static final String ORDERS_FIELDS = "orders.order_id order_id, orders.order_type order_type, orders.date_ordered order_date_ordered, orders.date_confirmed order_date_confirmed, orders.date_ready order_date_ready, orders.date_delivered order_date_delivered, orders.date_canceled order_date_canceled, orders.table_number order_table_number, orders.address order_address";
