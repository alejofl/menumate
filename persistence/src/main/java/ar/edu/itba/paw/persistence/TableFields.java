...
class TableFields {
    ...
    static final String USERS_FIELDS = "users.user_id user_id, users.username user_username, users.name user_name, users.email user_email, users.image_id user_image_id, users.is_active user_is_active";
